<!-- <footer class="footer py-6 @@classes">
    <div class="container"> -->
        <!-- <div class="row">
            <div class="col-md-4">
                <img class="navbar-brand-dark mb-4" height="35" src="@@path/assets/img/brand/light.svg" alt="Logo light">
        ...
        <div class="row">
            <div class="col mb-md-0">
                <a href="{{url('/')}}" target="_blank" class="d-flex justify-content-center">
                    <img src="{{asset('assets/img/themesberg-logo-alt.svg')}}" height="35" class="mb-4" alt="Themesberg Logo">
                </a>
            <div class="d-flex text-center justify-content-center align-items-center" role="contentinfo">
                <p class="fw-normal font-small mb-0">Copyright © 2010-<span class="current-year">2021</span>. Techno Deviser.</p>
                </div>
            </div>
        </div>
    </div>
...
<footer class="bg-white rounded shadow p-5 mb-4 mt-4">
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start">© 2021-<span class="current-year"></span> <a class="text-primary fw-normal" href="https://themesberg.com" target="_blank">Techno Deviser.</a></p>
        </div>
